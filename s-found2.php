...
<html lang="en">
    <HEAD>
            <meta charset="utf-8">
            <title>s-found 2 - a simplified way to make 2D games in code.</title>    
            ...
            <script src="NeilFraser-JS-Interpreter-9c09d45/acorn_interpreter.js"></script>
            <script src="google-blockly-f7a206a/blockly_compressed.js"></script>
            
            <script src="../google-blockly-f7a206a/blocks_compressed.js"></script>
            
            <script src="google-blockly-f7a206a/javascript_compressed.js"></script>
            <script src="google-blockly-f7a206a/msg/js/en.js"></script>
            <script src="google-blockly-f7a206a/generators/javascript/math.js"></script>
            <script src="google-blockly-f7a206a/generators/javascript/text.js"></script>
            <script src="google-blockly-f7a206a/generators/javascript/loops.js"></script>
            <script src="google-blockly-f7a206a/generators/javascript/variables.js"></script>
            

            <script src="google-blockly-f7a206a/blocks/colour.js"></script>
            <script src="google-blockly-f7a206a/blocks/lists.js"></script>
            <script src="google-blockly-f7a206a/blocks/logic.js"></script>
            <script src="google-blockly-f7a206a/blocks/loops.js"></script>
            <script src="google-blockly-f7a206a/blocks/math.js"></script>
            <script src="google-blockly-f7a206a/blocks/procedures.js"></script>
            <script src="google-blockly-f7a206a/blocks/text.js"></script>
            <script src="google-blockly-f7a206a/blocks/variables.js"></script>
    
            -->

            <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>s-found 2 the new tool to make 2d web games and games on android</title>
        <!-- CodeMirror CSS -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/codemirror@5.65.19/lib/codemirror.min.css">
        <!-- Dracula Theme (Optional) -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/codemirror@5.65.19/theme/dracula.min.css">
        <!-- Show Hint CSS -->
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/codemirror@5.65.19/addon/hint/show-hint.css">
        
        <style>
            a:link {color:rgb(255, 255, 0);}      /* unvisited link */
            a:visited {color:rgb(255, 255, 0);}  /* visited link */
            a:hover {color:rgb(255, 255, 0);}  /* mouse over link */
    ...
    <BODY>    
    <div id="examples-dialog" style="display:block; position: absolute; top:50%; left:50%; background-color: darkgray;    border: solid 4px lightgray; display: none;">
        <span class="closebtn"  onclick="this.parentElement.style.display='none';">&times;</span> 
        <strong>example programs:</strong>
        <BR> click on links below to load examples, then click Run
        <BR><a href=/s-found/s-found2.html?LoadFromUrl=https://raw.githubusercontent.com/amigojapan/s-found/refs/heads/gh-pages/s-found2-examples/ArrowGame.s-found2>
            [Arrow game] example
            </a>
        <BR><a href=/s-found/s-found2.html?LoadFromUrl=https://raw.githubusercontent.com/amigojapan/s-found/refs/heads/gh-pages/s-found2-examples/space-invaders.s-found2>
            [Space invaders] game example
            </a>
        <BR><a href=/s-found/s-found2.html?LoadFromUrl=https://raw.githubusercontent.com/amigojapan/s-found/refs/heads/gh-pages/s-found2-examples/frogger.s-found2>
            [Frogger] game example
            </a>
        <BR><a href=/s-found/s-found.html?LoadFromUrl=https://amigojapan.github.io/s-found/projects/bomberman/bmwalk_aliases_latest.s-found.txt>
            [Bomberman walk] game example
            </a>
        <BR><a href=/s-found/s-found.html?LoadFromUrl=https://amigojapan.github.io/s-found/projects/terminal_examples/terminal_guess_my_number5.s-found>
            [termianl example Guess my number game] example
            </a>
        <BR><a href=/s-found/s-found.html?LoadFromUrl=https://amigojapan.github.io/s-found/projects/terminal_examples/terminal_example2.s-found>
            [Terminal example simple cli and ascii art]
            </a>
            <BR><a href=/s-found/s-found.html?LoadFromUrl=https://amigojapan.github.io/s-found/projects/terminal_examples/current_bitcoin_value2.s-found>
            [HTTP Request and json parser example, current bitcoin value]
                </a>             
            <BR><a href=/s-found/s-found.html?LoadFromUrl=https://amigojapan.github.io/s-found/projects/terminal_examples/cli_gui4.s-found>
            [Terminal example3 cli interacting with gui]
            </a> 
        <BR><a href=/s-found/s-found.html?LoadFromUrl=https://amigojapan.github.io/s-found/projects/terminal_examples/fibonaci_term.s-found>
            [Terminal example Fibonacci]
            </a> 
        </div> 
        <div id='main-window' style="text-align: left; background:purple">
                <div id="warning_div" style="height: 100px; width: 655px; text-align: center; margin: 0 auto; background: red; color: yellow;"><h1>Loading...</h1></div>
                <div id="arcade-cabinet" style="width: 655px; text-align: center; margin: 0 auto; background: #000; color: #fff;">
                    <div id="arcade-banner" style="width: 655px; height: 53px;">
                        <img src="images/-S-Found2-banner.png" height==50, width=200">
                    </div> 
                    <div id="toolbar" style="display: inline;">
                        <input type="file" id="files" style="display:none; "/>
                        <img id="image" style="display:none;"/>
                        <a href="#" onclick='hide_sprite_manager_dialogbox();document.getElementById("run-game").style.display = "none";document.getElementById("code-editor").style.visibility="visible";document.getElementById("code-editor").style.display = "block"; // Hideshow_sprite_manager_dialogbox();updateDialogBox();'>Code editor</a>
                        <a href="#" onclick='hide_sprite_manager_dialogbox();document.getElementById("run-game").style.display = "block";document.getElementById("code-editor").style.display = "none";'>Run mode</a>
                        <a href="#" onclick='document.getElementById("run-game").style.display = "none";document.getElementById("code-editor").style.display = "none";show_sprite_manager_dialogbox();updateDialogBox();'>Sprite Manager</a>
                        ...
                        <a href="#" onclick="toggleShowTerminal()">Show Terminal</a>
                        
                        <a href="#" onclick="showScreenKeyboard()">Screen Controller</a>
                        ...
                        <a href="#" onclick='document.getElementById("examples-dialog").style.display="block";'>Examples</a>
                    </div>
                    <div id="sprite_manager_dialogbox" style="overflow-y: auto; height: 300px; border:1px solid yellow;display: none; text-align: left;"></div>                    
                    <div id="run-game">
                    <div id="arcade-border-left" style="float: left;width: 21px; height: 500px; display: inline;">
                        <img src="images/arcade_cabinet_border2.png">
                    </div>    
                    <div id="arcade-border-right" style="float: right;width: 21px; height: 500px; display: inline;">
                        <img src="images/arcade_cabinet_border2.png">
                    </div>
                
                    <div id="phaser" style="float: center; width: 600px; height: 400px; display: inline;"></div>
                    <div id="on_screen_controls" style="border:1px solid black; display: none;">
                        <div id="btnA" onmousedown="btnAmouseDown()" onmouseup="btnAmouseUp()" style="display: inline;"><img src="images/A.png"></div><div id="btnUp" onmousedown="btnUpmouseDown()" onmouseup="btnUpmouseUp()"style="display: inline;"><img src="images/arrow_up.png"></div><div id="btnB" onmousedown="btnBmouseDown()" onmouseup="btnBmouseUp()"style="display: inline;"><img src="images/B.png"></div><BR>
                        <div id="btnLeft" onmousedown="btnLeftmouseDown()" onmouseup="btnLeftmouseUp()" style="display: inline;"><img src="images/arrow_left.png"></div><div id="btnDown" onmousedown="btnDownmouseDown()" onmouseup="btnDownmouseUp()" style="display: inline;"><img src="images/arrow_down.png"></div><div id="btnRight" onmousedown="btnRightmouseDown()" onmouseup="btnRightmouseUp()" style="display: inline;"><img src="images/arrow_right.png"></div><BR>
                    </div>
                    <div id="termDiv" style="text-align: left; color: yellow; background-color: black;overflow-y: auto; border:1px solid black; width: 600px; display: none;">
                        <textarea rows="15" cols="50" id="term" style="color: yellow; background-color: black;resize: none; height: 150px; max-height: 150px; width: 600px; font-family:Consolas,Monaco,Lucida Console,Liberation Mono,DejaVu Sans Mono,Bitstream Vera Sans Mono,Courier New, monospace;"></textarea>
                    ...
                    <dix id="controls menu">
                        <p>
                            <!--<button onclick="wsToXML()">WS->XML</button>-->
                            <!--<button onclick="xmlToWS()">XML->WS</button>-->
                            <!--<button onclick="showJS()">show JS</button>-->
                            Speed <input type="text" value="250" ID="execution_speed">ms
                            <!--<input type="checkbox" ID="real-time-eval-checkbox"> Real-Time eval -->
                            <!--<button onclick="call_init();">call ON_STARUP()</button>-->
                ...
                <div id="bottom border" style="height: 10px; background-color: black;"></div>
                </div>
                <div id="bottom border" style="height: 10px; background-color: black;"></div>
            </div>
            <!---<BR><BR><BR><BR><BR><BR>
            <div id="blockly" style="display : none;">
                    <div id="programming-stuff" style="text-align: left;">
                    <div id="pages" style="text-align: left;">
                        pages div failed to initialize
                    </div>
                    ...
                    <xml id="toolbox" style="display: none">
                        ...
                        <block type="block_change_stage"></block>
                        </category>
                        ...
                        <block type="motion_point_in_direction_of_target"></block>
                            <block type="motion_point_in_direction_of_point"></block>
                        ...
                        <block type="sprites_set_frame_to_frame_number"></block>
                            <block type="sprites_set_frame_to_frame_number2"></block>
                        ...
                        <block type="sprites_value_of_y"></block>
                            <block type="sprites_sprite_width"></block>
                            <block type="sprites_sprite_height"></block>
                            <block type="sprites_world_width"></block>
                            <block type="sprites_world_height"></block>	
                            <block type="sprites_distance_between_sprite_and_target"></block>
                    ...
                    <category name="Variables" colour="330" custom="VARIABLE"></category>
                        ...
                        <category name="Advanced">
                                ...
                                <block type="api_http_response_text"></block>
                                <block type="api_fetch_json_value"></block>
                                <block type="procedures_defreturn_functional"></block>
                                <block type="call_first_class_function"></block>
                                <block type="set_timer"></block>
                                <block type="set_one_time_timer"></block>
                                <block type="clear_timer"></block>
                                <block type="set_break_point_here"></block>
                        </category>
                ...
                <div ID="code-editor" style="visibility: hidden;">
                    <textarea ID="code_text_area">//Start coding here</textarea>
                </div>
                ...
                <!-- Show Hint Addon -->
                <script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.19/addon/hint/show-hint.js"></script>
                <!-- JavaScript Hint Addon -->
                <script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.19/addon/hint/javascript-hint.js"></script>

                <!-- Initialize CodeMirror -->
                <script>
                    editor = CodeMirror.fromTextArea(document.getElementById("code_text_area"), {
                        lineNumbers: true,
                        mode: "javascript",
                        theme: "dracula",
                        hintOptions: {
                    ...
                    // Automatic autocompletion on inputRead
        ...
        <script>
            ...
            //var RunCode
            var MyState;
                function set_all_fames_to_first_frame() {
                    var go;
                    for(var sprite in sprites) {
                        set_current_sprite_name(sprites[sprite].name)
                        go=find_sprite_object_by_name(current_sprite_name);
                        if_frames_exist_set_frame_to_first_frame(go);
                    }
                }
                var URLRunLoading=false;
                ...
                function show_warning(msg) {
                    ...
                    var warning_msg = document.getElementById("warning_message");
                    warning_div.style.display='block';
                    warning_msg.innerHTML=msg;
                }
                ...
                window.addEventListener("message", (event) => {
                    if (event.origin !== "https://amjp.psy-k.org") {
                        {alert("wrong origin");return;} // Ignore messages from unknown origins
                    }

                    const { action, data } = event.data;
                    if (action === "RUN") {
                        //alert("Received from parent:"+ data);
                        loaProjectFromJSONString(data);
                        hide_warning();
                        
                    }
                });
	
                window.addEventListener('load', function(){//there is another onload further down, I think maybe I should merge it into this in hte future. I think maybe this one is the newer kind, I think just make the second one into a normal function and call it from here
                            //obtain program form post
                            //var postValue = '<?php //if (isset($_POST["jsonapp"])) {echo $_POST["jsonapp"]; }else{ echo "empty";} ?>';
                            //return;
                            var postValue = <?php if(isset($_POST["jsonapp"])){echo $_POST["jsonapp"];}else{echo "'empty'";} ?>;
                            if(postValue!="empty") {
                                URLRunLoading==true
                                //load program from post value
                                //console.log("start"+postValue+"end");
                                //loaProjectFromJSONString(postValue);

                            }else{
                                //remove loading here
                                return;
                            } 
                            //load example if anyis given by URL
                            var URL = getParameterByName("LoadFromUrl");
                            if(URL != "") {
                                loadURLproject(URL,false);
                            } 
                            var URL = getParameterByName("RunAndLoadFromUrl");
                            if(URL != "") {
                                URLRunLoading=true;
                                loadURLproject(URL,true);
                            } 	
                            if(URLRunLoading) {
                                 show_warning("Now loading, please wait about 10 seconds to finish loading...");
                            }
                            //setBackgroundColor();
                   ...
                   */
                                //binding screen controller events
                    var box1 = document.getElementById('btnA')
                    ...
                    var box1 = document.getElementById('btnB')
                    box1.addEventListener('touchstart', function(e){
                        var touchobj = e.changedTouches[0] // reference first touch point (ie: first finger)
                        btnBmouseDown();
                        e.preventDefault()
                    ...
                    var box1 = document.getElementById('btnUp')
                    box1.addEventListener('touchstart', function(e){
                        var touchobj = e.changedTouches[0] // reference first touch point (ie: first finger)
                        btnUpmouseDown();
                        e.preventDefault()
                    ...
                    var box1 = document.getElementById('btnDown')
                    box1.addEventListener('touchstart', function(e){
                        var touchobj = e.changedTouches[0] // reference first touch point (ie: first finger)
                        btnDownmouseDown();
                        e.preventDefault()
                    ...
                    var box1 = document.getElementById('btnLeft')
                    box1.addEventListener('touchstart', function(e){
                        var touchobj = e.changedTouches[0] // reference first touch point (ie: first finger)
                        btnLeftmouseDown();
                        e.preventDefault()
                    ...
                    var box1 = document.getElementById('btnRight')
                    box1.addEventListener('touchstart', function(e){
                        var touchobj = e.changedTouches[0] // reference first touch point (ie: first finger)
                        btnRightmouseDown();
                        e.preventDefault()
                    ...
                    */
                   //finish by hiding the loading warning then finished loading
                   hide_warning();
                }, false)
                //screen controller
                var onScreenKeyboard={};
                onScreenKeyboard.btnAPressed=false;
                function btnAmouseDown() {
                    onScreenKeyboard.btnAPressed=true;
                }
                function btnAmouseUp() {
                    onScreenKeyboard.btnAPressed=false;
                }
                
                onScreenKeyboard.btnBPressed=false;
                function btnBmouseDown() {
                    onScreenKeyboard.btnBPressed=true;
                }
                function btnBmouseUp() {
                    onScreenKeyboard.btnBPressed=false;
                }
                
                onScreenKeyboard.btnUpPressed=false;
                function btnUpmouseDown() {
                    onScreenKeyboard.btnUpPressed=true;
                }
                function btnUpmouseUp() {
                    onScreenKeyboard.btnUpPressed=false;
                }
                    
                onScreenKeyboard.btnDownPressed=false;
                function btnDownmouseDown() {
                    onScreenKeyboard.btnDownPressed=true                }
                function btnDownmouseUp() {
                    onScreenKeyboard.btnDownPressed=false;
                }
                    
                onScreenKeyboard.btnLeftPressed=false;
                function btnLeftmouseDown() {
                    onScreenKeyboard.btnLeftPressed=true;
                }
                function btnLeftmouseUp() {
                    onScreenKeyboard.btnLeftPressed=false;
                }
                    
                onScreenKeyboard.btnRightPressed=false;
                function btnRightmouseDown() {
                    onScreenKeyboard.btnRightPressed=true;
                }
                function btnRightmouseUp() {
                    onScreenKeyboard.btnRightPressed=false;
                }	
                    
                //var kb_id;
                function showScreenKeyboard() {
                    //if (typeof kb_id !== 'undefined') window.clearInterval(kb_id);
                    //kb_id = setInterval(logbuttons,100);
                    document.getElementById("on_screen_controls").style.display="inline-block";
                }
                //terminal
                function termOnGetFocus() {
                    unblockKeys();
                }
                function termOnLoseFocus() {
                    lockKeysForGame();
                }
                function cls() {
                ...
                var input=null;
                var parsed;
                window.onload = function() {//have 2 load functions, maybe merge them in the future...
                ...
                function updateDialogBox() {
                    ...
                    document.getElementById("sprite_manager_dialogbox").innerHTML +=" <a href=https://www.piskelapp.com/ target=\"Sprite editor\">Open exrnal sprite editor in new tab</a> remember to save as PNG.";
                        ...
                        if(project.game_objects[obj].name==game_object_name) {
                            for(frame in project.game_objects[obj].frames) {
                                if(project.game_objects[obj].frames[frame].alias==frame_alias) {
                                    return project.game_objects[obj].frames[frame].frame_image_data;//this frames is text which I should change later but it would brake the images in my projects so I will just change the loading from project to string
                                }
                            }
                        }
                    }
                ...
                function clikedDeleteFrameLink(obj,frame) {
                  ...
                  if (answer) {
                    //project.game_objects[obj].frames[frame].destroy();
                    sprites[obj].frames[frame+1].sprite.destroy();//BUG:this deletes the frame sprite apparently but then it is impossible to add a new sprite
                ...
                function clikedDeleteSpriteLink(game_object_name) {
                    ...
                    if (answer) {
                        for(sprite in sprites) {
                            if(sprites[sprite].name==game_object_name) {
                                //delete sprites[sprite]; //https://github.com/amigojapan/s-found/issues/3
                                sprites[sprite].sprite.destroy();//this should fix the issue
                            }
                        }
                        for(var obj in project.game_objects) {
                            if(project.game_objects[obj].name==game_object_name) {
                        ...
                        //need to dete from images too and from sprites and from game_objects
                        //make sure to do it by name, nor sure if the index will always be the same
                        for(var index in project.images) {
                            if(project.images[index].name==game_object_name) {
                                //project.images.splice(13, 1);
                                project.images.splice(index, 1);
                                break;
                            }
                        }
                        for(var index in sprites) {
                            if(sprites[index].name==game_object_name) {
                                //sprites.splice(13, 1)
                        ...
                        for(var index in project.game_objects) {
                            if(project.game_objects[index].name==game_object_name) {
                                //project.game_objects.splice(13, 1)
                                project.game_objects.splice(index, 1);
                                break;
                            }
                        }
                        //***TODO:need to also delete the object from teh canvas, but for now i will just reload hte project after saving it,that is more sure to work			
                        updateDialogBox();
                    }
                }
                ...
                MyState = {
                    ...
                    create: function() {
                        ...
                        game.stage.disableVisibilityChange = false;//pause the game when lost focus(seems to not be working)
                        ...
                        */
                       //take away the this. try withoughht it
                        background_ = game.add.group();
                        background_.z = 0;
                        mid_layer = game.add.group();
                        mid_layer.z = 1;
                        ...
                        button_layer = game.add.group();
                        button_layer.z = 3;
                        //sprites[obj].sprite.inputEnabled = false;    // Add on-screen control buttons as Phaser sprites
                        this.btnUp = button_layer.create(50, 300, 'arrow_up');//game.add.sprite(50, 300, 'arrow_up');
                        this.btnUp.alpha = 0.5;
                        this.btnUp.inputEnabled = true;
                        this.btnUp.events.onInputDown.add(() => { onScreenKeyboard.btnUpPressed = true; }, this);
                        this.btnUp.events.onInputUp.add(() => { onScreenKeyboard.btnUpPressed = false; }, this);
                        this.btnUp.bringToTop();

                        this.btnDown = button_layer.create(50, 350, 'arrow_down');
                        this.btnDown.alpha = 0.5;
                        this.btnDown.inputEnabled = true;
                        this.btnDown.events.onInputDown.add(() => { onScreenKeyboard.btnDownPressed = true; }, this);
                        this.btnDown.events.onInputUp.add(() => { onScreenKeyboard.btnDownPressed = false; }, this);
                        this.btnDown.bringToTop();

                        this.btnA = button_layer.create(0, 300, 'A');
                        this.btnA.alpha = 0.5;
                        this.btnA.inputEnabled = true;
                        this.btnA.events.onInputDown.add(() => { onScreenKeyboard.btnAPressed = true; }, this);
                        this.btnA.events.onInputUp.add(() => { onScreenKeyboard.btnAPressed = false; }, this);
                        this.btnA.bringToTop();

                        this.btnB = button_layer.create(100, 300, 'B');
                        this.btnB.alpha = 0.5;
                        this.btnB.inputEnabled = true;
                        this.btnB.events.onInputDown.add(() => { onScreenKeyboard.btnBPressed = true; }, this);
                        this.btnB.events.onInputUp.add(() => { onScreenKeyboard.btnBPressed = false; }, this);
                        this.btnB.bringToTop();

                        this.btnLeft = button_layer.create(0, 350, 'arrow_left');
                        this.btnLeft.alpha = 0.5;
                        this.btnLeft.inputEnabled = true;
                        this.btnLeft.events.onInputDown.add(() => { onScreenKeyboard.btnLeftPressed = true; }, this);
                        this.btnLeft.events.onInputUp.add(() => { onScreenKeyboard.btnLeftPressed = false; }, this);
                        this.btnLeft.bringToTop();

                        this.btnRight = button_layer.create(100, 350, 'arrow_right');
                        this.btnRight.alpha = 0.5;
                        this.btnRight.inputEnabled = true;
                        this.btnRight.events.onInputDown.add(() => { onScreenKeyboard.btnRightPressed = true; }, this);
                        this.btnRight.events.onInputUp.add(() => { onScreenKeyboard.btnRightPressed = false; }, this);
                        this.btnRight.bringToTop();
                    },
                    ...
                    update: function() {
                        ...
                        //        if (game.time.now > 5000 && !this.sprite.inputEnabled) {
                    ...
                    onBoardClick: function(sprite, pointer) {
                        //embed this in code and call mouse click event, send key
                        let spriteName = sprite.key.slice(3); // Removes the first 3 characters
                        onSpriteClick(spriteName,pointer,sprite);
                    }
                };
                
                //var game = new Phaser.Game(600, 400, Phaser.CANVAS, 'phaser', { preload: preload, create: create, update: update }, MyState);
                
                var game = new Phaser.Game(600, 400, Phaser.AUTO, 'phaser', MyState);
                function preload() {
                    game.load.image('arrow_up', 'images/arrow_up.png');
                    game.load.image('arrow_down', 'images/arrow_down.png');
            ...
            */
            /*
                ...
                */
                ...
                function clone_sprite(enable_input=false) {
                    var game_object;
                    ...
                    //clone.frames= Object.assign({}, game_object.frames);//***TODO:this does not work, clone the frames from teh original frames the same way I did the clonning on top...
                    //***TO-DO:need to set the alias by project.game_objects[3].frames[1]
                    
                    // Enable input and attach click event
                    if(enable_input) {
                        clone.sprite.inputEnabled = true;
                        clone.sprite.events.onInputDown.add(MyState.onBoardClick, MyState);
                    }
                    
                    clone.frames=[]
                    for(frame in game_object.frames) {
                        clone.frames[frame]={};
                        clone.frames[frame].sprite = game.add.sprite(game_object.sprite.x, game_object.sprite.y, game_object.frames[frame].sprite.key, game_object.frames[frame].sprite.frame);
                    }
                    
                    found=false;
                    for(proj_index in project.game_objects) {
                        if(project.game_objects[proj_index].name==current_sprite_name) {
                            break;
                        }
                    }
                    var first_frame_index1=false;
                    for(frame in game_object.frames) {
                        //fudge to deal with off by one problem which happens sometimes
                        try {
                            clone.frames[frame].alias = project.game_objects[proj_index].frames[frame-1].alias;
                        } catch(err) {
                            //if you reach here it is probably because of a mistake in the sprite manager, when I created top_sun I added some junk images and deleted them, and it ended up with index 0, ***TODO:fix bug in sprite manager that causes this problem
                            //fudge to correct some stupid off by one error
                            clone.frames[frame].alias = project.game_objects[proj_index].frames[frame-2].alias;
                        }
                        clone.frames[frame].sprite.visible=false;
                    }
                    game_object.sprite.visible=false;//I don't think this should exist , but I am adding it cause there seems to be a duplicate fo zombie bare
                    clone.number_of_frames=game_object.number_of_frames;
                    clone.current_frame=1;
                    //clone.name=game_object.name;
                    ...
                    current_clone=game_object.clones.length-1;//(yeah this seems so)maybe -1
                }
                
                function destroy_current_sprite(){
                    //if(current_clone_object){
                    //    current_clone_object.sprite.destroy();
                    //}
                    var game_object;
                    game_object=find_sprite_object_by_name(current_sprite_name);
                    destory_current_sprite_frames();
                ...
                function hide_current_sprite(){
                    var game_object;
                    game_object=find_sprite_object_by_name(current_sprite_name);
                    game_object.hidden=true;
                    if(current_clone!=null) {
                        //(done)***TODO:need to deal with number_of_frames == 'undefined' for clones too as well as non clones
                        game_object.sprite.visible=false//make sure the top srite is invisible now
                        //hided current clone
                        game_object.clones[current_clone].sprite.visible=false;
                        //fudge to make all other frames invisible cause there seems to be all frames visible now with clones
                        for(frame in game_object.frames) {
                            game_object.frames[frame].sprite.visible=false;
                        }
                    }
                ...
                function find_last_clone() {
                    for(var obj in sprites){
                        if(sprites[obj].name==current_sprite_name) {
                            return sprites[obj].clones[sprites[obj].clones.length-1];
                        }
                    }
                }	
                    ...
                    for(var obj in sprites){
                        if(sprites[obj].name==sprite_name) {
                            if(current_target_clone!=null) {
                                ...
                                //not this wont work well if we are actually looking for hte clones of the target, but that is not what I think we have in mind,(fixed this --->) at least in space invaders
                                //it should work if the target has clones, so may work anyway
                                //a sideeffect of this is that the bullet gets hidden when I am just trying to hide the alines.
                                if(sprites[obj].clones.length==0){
                                    return sprites[obj]
                ...
                */
                ...
                function point_in_direction_broken(a_x,a_y,b_x,b_y) {
                    /*
                    ...
                    */
                    ...
                    //this does not work either. angle_radians=Math.atan2(dx,dy);
                ...
                function distance_between_sprite_and_target() {
                    var game_object;
                    game_objectA=find_sprite_object_by_name(current_sprite_name);
                    var game_object;
                    game_objectB=find_sprite_object_by_name(target_sprite_name);
            
                    var a = game_objectA.sprite.x - game_objectB.sprite.x;
                    var b = game_objectA.sprite.y - game_objectB.sprite.y;
            
                    var c = Math.sqrt( a*a + b*b );
                    return c;// c is the distance
                }
                function set_current_clone_x_to(X) {
                    if(current_clone_object!=null){
                        current_clone_object.sprite.x=X;
                        return;
                    }
                }

                function set_current_clone_y_to(Y) {
                    if(current_clone_object!=null){
                        current_clone_object.sprite.y=Y;
                        return;
                    }
                }
                ...
                function get_x_value() {
                    if(current_clone_object){
                        return current_clone_object.sprite.x
                    }
                    return find_sprite_object_by_name(current_sprite_name).sprite.x;
                } 
                function get_y_value() {
                    if(current_clone_object){
                        return current_clone_object.sprite.y
                    }
                    return find_sprite_object_by_name(current_sprite_name).sprite.y;
                }

                function sprite_width() {
                    return find_sprite_object_by_name(current_sprite_name).sprite.width;
                } 
                function sprite_height() {
                    return find_sprite_object_by_name(current_sprite_name).sprite.height;
                } 	
            
            //[8:41pm] amigojapan_bnc: ok okuu , I will fix it later, thanks for the help
            //okuu: ]later tell amigojapan_bnc Updated the gist. I have to go to class, but when you do test it, please notify me of the results. Send the message to unyu, not okuu.
            function biased(a,b,c,d) {
                return (a <= c && c < b) || (a < d && d <= b)
            }
            
            function unbiased(a,b,c,d) {
                return biased(a,b,c,d) || biased(c,d,a,b);
            }
            
            function collision(r1,r2) {
                // This code assumes that top < bottom,
                // otherwise swap the tops and bottoms
                // in the last line.
                return unbiased(r1.left,r1.right,r2.left,r2.right) &&
                       unbiased(r1.top,r1.bottom,r2.top,r2.bottom);
            }
                ...
                function is_colliding_with_target() {
                    if(current_clone_object!=null){
                        //handle clones
                        game_objectA=current_clone_object
                    }else{
                        var game_objectA;
                        game_objectA=find_sprite_object_by_name(current_sprite_name);
                    }
                ...
                function next_fame() {
                    ...
                    if(game_object.hidden==false) {
                        game_object.frames[game_object.current_frame].sprite.visible=true;
                    }
                }
                function set_frame_to_frame_number(frame_number_or_alias, force_game_object) {
                    var game_object;
                    if(arguments.length==2) {//this checks to see how many arguments where passes into the function
                        game_object=find_sprite_object_by_name(force_game_object);
                  } else {
                        game_object=find_sprite_object_by_name(current_sprite_name);
                    }
                    if (typeof game_object.number_of_frames == 'undefined') {
                                ...
                                if(project.game_objects[obj].name==game_object.name) {
                                    for(frame_index in project.game_objects[obj].frames) {
                                        if(project.game_objects[obj].frames[frame_index].alias==frame_alias) {
                                            //return project.game_objects[obj].frames[frame].frame_image_data;
                                            var frame_number=parseInt(frame_index);
                                            game_object.frames[frame_number+1].sprite.visible=true;//adjusting cause the frames in game_object.frames are indexed on 1, but the frames of the project are indexed on 0
                                            return;
                                            //found=true;
                                            //break;//i think i could add this to both the next for loop too and in clones for optimization
                                        }
                                    }
                                }
                            }
                ...
                var current_clone_object;
                function for_each_clone(f){
                    var game_object = find_sprite_object_by_name(current_sprite_name);
                    for(var c in game_object.clones) {
                        cloneSprite=game_object.clones[c].sprite
                        thisClone=game_object.clones[c];
                        current_clone_object=game_object.clones[c];
                        current_clone=c;
                        f();
                    } 
                    cloneSprite=null;
                    current_clone_object=null;
                    current_clone=null;
                    thisClone=null;
                }
                function for_each_clone_new(f){
                    var game_object = find_sprite_object_by_name(current_sprite_name,"original sprite");
                    for(var c in game_object.clones) {
                        cloneSprite=game_object.clones[c].sprite
                        current_clone_object=game_object.clones[c];
                        current_clone=c;
                ...
                function destory_current_clone(){
                    go=find_sprite_object_by_name(current_sprite_name)
                    go.clones.splice(current_clone,1)
                    cloneSprite.destroy();  
                }
                function destroy_current_clone(){
                    destory_current_clone();  
                }
                function change_view_size(width,height){
                    // Get the div element by its ID
                    const myDiv = document.getElementById('phaser');
                ...
                //end phaser
                    var workspace_hidden;
                    var workspace;
            
                     //var workspace_hidden = Blockly.inject('blocklyDiv_hidden',{media: '../../media/',toolbox: document.getElementById('toolbox')});Blockly.Xml.domToWorkspace(document.getElementById('startBlocks'),workspace_hidden);
            
                /*deprecared
                var workspace = Blockly.inject('blocklyDiv',{media: '../../media/',toolbox: document.getElementById('toolbox')});Blockly.Xml.domToWorkspace(workspace,document.getElementById('startBlocks'));
            
                var workspace_hidden = Blockly.inject('blocklyDiv_hidden',{media: '../../media/',toolbox: document.getElementById('toolbox')});Blockly.Xml.domToWorkspace(workspace,document.getElementById('startBlocks'));
            
                var workspace_hidden = Blockly.inject('blocklyDiv_hidden',{media: '../../media/',toolbox: document.getElementById('toolbox')});Blockly.Xml.domToWorkspace(document.getElementById('startBlocks'),workspace_hidden);
            
                //var workspace = Blockly.inject('blocklyDiv',{media: '../../media/',toolbox: document.getElementById('toolbox')});Blockly.Xml.domToWorkspace(document.getElementById('startBlocks'),workspace);
            ...
            workspace = Blockly.inject('blocklyDiv',
                ...
                function initApi(interpreter, scope) {
                  ...
                  interpreter.setProperty(scope, 'foward', interpreter.createNativeFunction(wrapper));
                ...
                */
                ...
                function generateJS(add_highlighting) {
                    //TO-DO:***update the JS the displayed code window, this seems to be old...
                    ...
                    //if(!generation_complete){
                        ...
                        */				
                        for(var pageindex in project.pages){
                            ...
                            //Blockly.Xml.domToWorkspace(xml,workspace_hidden);	
                            //gegerate
                            if(add_highlighting) {
                                //Blockly.JavaScript.addReservedWords('highlightBlock');
                        ...
                        //document.getElementById("code_text_area").value = Code;
                        return Code;
                        //generation_complete=true;
                    //}
                }
                function lockKeysForGame() {
                      //extra keys
                    aKey = game.input.keyboard.addKey(Phaser.Keyboard.A);
                    bKey = game.input.keyboard.addKey(Phaser.Keyboard.B);		
                }
                ...
                function evalCode() {
                    //update_workspace_code_in_projet();
                    //terminal
                    number_of_inputs=0;
                    lockKeysForGame();
                    //var xml = Blockly.Xml.workspaceToDom(workspace);
                  ...
                  //Unless I am mistaken there isn't a way currently to call into the context created when running a program with the JSInterpreter. On workaround could be to have a setInterval going inside the interpreter context that is polling an exposed api which is watching for events on the page and responds by calling your users code. https://neil.fraser.name/software/JS-Interpreter/docs.html
                    //finalCode = generateJS(true);//**here too?
                    //const textarea = document.getElementById("code_text_area");
                    const fullText = editor.getValue();
                    evalRun=true;
                    finalCode= "function ON_STARTUP(){}\n";
                    finalCode+= "//Beginningn User code:\n";
                    finalCode+= fullText+"\n";
                    finalCode+= "//End user code\n";
                  ...
                  //cursor key events
                    evalRun=true;
                    //URLRunLoading=true;
                    //***TODO:handle isUP https://github.com/photonstorm/phaser/issues/474
                    ...
                    finalCode+= "	}\n";		
                    finalCode+= "	if (cursors.left.isDown||onScreenKeyboard.btnLeftPressed) {\n"
                    finalCode+= "		if (typeof LEFT_KEY_PRESSED !== 'undefined') {\n";//cehck to see if funtion is defined
                    finalCode+= "			LEFT_KEY_PRESSED();\n";
                    finalCode+= "		}\n";
                    finalCode+= "	}\n"
                    finalCode+= "	if (cursors.right.isDown||onScreenKeyboard.btnRightPressed) {\n"
                    finalCode+= "		if (typeof RIGHT_KEY_PRESSED !== 'undefined') {\n";//cehck to see if funtion is defined
                    finalCode+= "			RIGHT_KEY_PRESSED();\n";
                    finalCode+= "		}\n";
                    finalCode+= "	}\n"
                    finalCode+= "	if (cursors.up.isDown||onScreenKeyboard.btnUpPressed) {\n"
                    finalCode+= "		if (typeof UP_KEY_PRESSED !== 'undefined') {\n";//cehck to see if funtion is defined
                    finalCode+= "			UP_KEY_PRESSED();\n";
                    finalCode+= "		}\n";
                    finalCode+= "	}\n"
                    finalCode+= "	if (cursors.down.isDown||onScreenKeyboard.btnDownPressed) {\n"
                    finalCode+= "		if (typeof DOWN_KEY_PRESSED !== 'undefined') {\n";//cehck to see if funtion is defined
                    finalCode+= "			DOWN_KEY_PRESSED();\n";
                    finalCode+= "		}\n";
                    finalCode+= "	}\n";
                    finalCode+= "	if (aKey.isDown||onScreenKeyboard.btnAPressed) {\n"
                    finalCode+= "		if (typeof A_KEY_PRESSED !== 'undefined') {\n";//cehck to see if funtion is defined
                    finalCode+= "			A_KEY_PRESSED();\n";
                    finalCode+= "		}\n";
                    finalCode+= "	}\n";
                    finalCode+= "	if (bKey.isDown||onScreenKeyboard.btnBPressed) {\n"
                    finalCode+= "		if (typeof B_KEY_PRESSED !== 'undefined') {\n";//cehck to see if funtion is defined
                    finalCode+= "			B_KEY_PRESSED();\n";
                    finalCode+= "		}\n";
                    finalCode+= "	}\n";
                    finalCode+= "}\n";
                    finalCode+= "if (typeof window.id_ !== 'undefined') window.clearInterval(window.id_);\n";
                    finalCode+= "window.id_ = setInterval(pollEvent, 60);\n"; //60 is the average of game.time.fps
                    finalCode+= "console.log('setting interval to 60FPS id:'+window.id_);\n";			
                    finalCode+= "if(URLRunLoading==true){setTimeout(function(){ evalRun=true;ON_STARTUP();hide_warning();}, 10000);}else{evalRun=true;ON_STARTUP();}\n";//I think this fudge will wait until the ON_STARTUP() function is ready to be called, avoiding the race condition of when the browser is still loading;		
                    
                    destory_all_clones();//this works in nikurabero2 but seems to break bomberman walk test,hmm the debugger does not even stop at this line :(
                    set_all_fames_to_first_frame();
                    //eval(finalCode);
                    //alert(finalCode);
                    try{
                ...
                function showJS() {
                  ...
                  //evalRun=true;
                    ...
                    set_all_fames_to_first_frame();
                    //eval(finalCode);
                    document.getElementById('code_text_area').value = finalCode;
                    //scroll down to the code area
                    location.hash ='code_text_area';
                }
                function runCode() {	
                    var execution_speed =document.getElementById('execution_speed').value;
                    id = setInterval(stepCode, parseInt(execution_speed));
                ...
                function saveCode() {
                    ...
                    var xml = Blockly.Xml.workspaceToDom(workspace);
                    var xml_text = Blockly.Xml.domToPrettyText(xml);
                    document.getElementById("code_text_area").value = xml_text;
                    //mock download
                    project.block_xml = xml_text;
                    */
                    //update_workspace_code_in_projet();
                    project.JScode= editor.getValue();
                    var project_json = JSON.stringify(project);
                    var project_name=prompt("Enter project name","GAME.s-found2");
                    download(project_name,project_json);
                }
            
                function xmlToWS() {	
                        Blockly.mainWorkspace.clear();
                        var xml = Blockly.Xml.textToDom(document.getElementById("code_text_area").value);
            ...
            //the following line is an imperitive do not erase
            //imperitive:do not interlace this block(this is not a commend)	
             /*
                ...
                Blockly.Blocks['sprites_set_current_sprite_force_next_statement'] = {
                  init: function() {
                    this.appendDummyInput()
                        .appendField("set the current sprite (next statement thread safe)");
                    this.appendValueInput("SPRITE_OPTION_BOX")
                        .setCheck("String")
                        //.appendField(new Blockly.FieldDropdown(parent_), "sprite");
                        .appendField(new Blockly.FieldDropdown(dynamicOptions), "sprite");
                ...
                Blockly.JavaScript['sprites_set_current_sprite_force_next_statement'] = function(block) {
                  var dropdown_sprite = block.getFieldValue('sprite');
                  var value_sprite_option_box = Blockly.JavaScript.valueToCode(block, 'SPRITE_OPTION_BOX', Blockly.JavaScript.ORDER_ATOMIC);
                  //var angle_a = block.getFieldValue('A');
                  //var value_angle = Blockly.JavaScript.valueToCode(block, 'ANGLE', Blockly.JavaScript.ORDER_ATOMIC);
                  ...
                  var code = 'set_current_sprite_name("'+sprite_name_final+'");';//just used not newline to force next statement.
                  return code;
                };
                ...
                //https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#3r5kjk
                ...
                Blockly.Blocks['sprites_set_frame_to_frame_number2'] = {
                  init: function() {
                    this.appendValueInput("FRAME_NUMBER")
                        .appendField("set frame to frame");
                    this.appendValueInput("SPRITE")
                        .appendField("of sprite");					
                    this.setPreviousStatement(true);
                    this.setNextStatement(true);
                    this.setColour(260);
                    this.setTooltip('');
                ...
                Blockly.JavaScript['sprites_set_frame_to_frame_number2'] = function(block) {
                  var value_FRAME_NUMBER = Blockly.JavaScript.valueToCode(block, 'FRAME_NUMBER', Blockly.JavaScript.ORDER_ATOMIC);
            
                  // TODO: Assemble JavaScript into code variable.
                  var argument0 = Blockly.JavaScript.valueToCode(block, 'FRAME_NUMBER',Blockly.JavaScript.ORDER_NONE) || '\'\'';
                  var argument1 = Blockly.JavaScript.valueToCode(block, 'SPRITE',Blockly.JavaScript.ORDER_NONE) || '\'\'';
                  var code = 'set_frame_to_frame_number('+argument0+','+argument1+');\n';
                  return code;
                };
                ...
                Blockly.Blocks['sprites_world_width'] = {
                  init: function() {
                    this.appendDummyInput()
                ...
                Blockly.JavaScript['sprites_world_width'] = function(block) {
                  // TODO: Assemble JavaScript into code variable.
                    var code = "parseInt(game.world.bounds.bottomRight.x)";;
                  // TODO: Change ORDER_NONE to the correct strength.
                  //return [code, Blockly.JavaScript.ORDER_NONE];
                  return [code, Blockly.JavaScript.ORDER_ATOMIC];
                };
                Blockly.Blocks['sprites_world_height'] = {
                  init: function() {
                    this.appendDummyInput()
                ...
                Blockly.JavaScript['sprites_world_height'] = function(block) {
                  // TODO: Assemble JavaScript into code variable.
                    var code = "parseInt(game.world.bounds.bottomRight.y)";;
                  // TODO: Change ORDER_NONE to the correct strength.
                  //return [code, Blockly.JavaScript.ORDER_NONE];
                  return [code, Blockly.JavaScript.ORDER_ATOMIC];
                };
            
                Blockly.Blocks['sprites_sprite_width'] = {
                  init: function() {
                    this.appendDummyInput()
                        .appendField("sprite width");
                    this.setOutput(true, "Number");
                    this.setColour(210);
                    this.setTooltip('');
                    this.setHelpUrl('http://www.example.com/');
                ...
                Blockly.JavaScript['sprites_sprite_width'] = function(block) {
                  // TODO: Assemble JavaScript into code variable.
                    var code = "parseInt(sprite_width())";;
                  // TODO: Change ORDER_NONE to the correct strength.
                  //return [code, Blockly.JavaScript.ORDER_NONE];
                  return [code, Blockly.JavaScript.ORDER_ATOMIC];
                };
                Blockly.Blocks['sprites_sprite_height'] = {
                  init: function() {
                    this.appendDummyInput()
                        .appendField("sprite height");
                    this.setOutput(true, "Number");
                    this.setColour(210);
                    this.setTooltip('');
                    this.setHelpUrl('http://www.example.com/');
                ...
                Blockly.JavaScript['sprites_sprite_height'] = function(block) {
                  // TODO: Assemble JavaScript into code variable.
                    var code = "parseInt(sprite_height())";;
                  // TODO: Change ORDER_NONE to the correct strength.
                  //return [code, Blockly.JavaScript.ORDER_NONE];
                  return [code, Blockly.JavaScript.ORDER_ATOMIC];
                };
                ...
                Blockly.Blocks['sprites_distance_between_sprite_and_target'] = {
                  init: function() {
                    this.appendDummyInput()
                        .appendField("distance between sprite and target");
                    this.setOutput(true, "Number");
                    this.setColour(210);
                    this.setTooltip('');
                    this.setHelpUrl('http://www.example.com/');
                ...
                Blockly.JavaScript['sprites_distance_between_sprite_and_target'] = function(block) {
                  // TODO: Assemble JavaScript into code variable.
                    var code = "parseInt(distance_between_sprite_and_target())";;
                  // TODO: Change ORDER_NONE to the correct strength.
                  //return [code, Blockly.JavaScript.ORDER_NONE];
                  return [code, Blockly.JavaScript.ORDER_ATOMIC];
                };
                ...
                Blockly.Blocks['set_break_point_here'] = {
                  init: function() {
                    this.appendDummyInput()
                        .appendField("set break point here");
                    this.setPreviousStatement(true);
                    this.setNextStatement(true);
                    this.setColour(260);
                    this.setTooltip('');
                ...
                Blockly.JavaScript['set_break_point_here'] = function(block) {
                  // TODO: Assemble JavaScript into code variable.
                  var code = 'debugger;//bring up debugger at this point\n';
                  return code;
                };
                ...
                Blockly.JavaScript['sprites_for_each_clone_of_current_sprite'] = function(block) {
                  ...
                  code+='	current_clone=clone;\n';
                    //all clones traversed code+='	console.log("current_clone"+current_clone);\n';
                ...
                */
                var debuggerCode;
                function destory_all_sprites(){//this does not seem to work, and it iok for now cause I plan on reloading the whole page every time, but this is difficult for developing, eventually I shoudl fix it...stop and start does nto work with clones :(
                    for(var sprite in sprites){
                        //also destroy frames of clones
                        set_current_sprite_name(sprites[sprite].name);
                        game_object=find_sprite_object_by_name(current_sprite_name);
                        destroy_current_sprite();
                    }
                }
                function destroy_all_sprites(){//this does not seem to work, and it iok for now cause I plan on reloading the whole page every time, but this is difficult for developing, eventually I shoudl fix it...stop and start does nto work with clones :(
                    destory_all_sprites();
                }
            
                function destory_current_sprite_frames(){
                        game_object=find_sprite_object_by_name(current_sprite_name);
                        for(frame in game_object.frames) {
                            game_object.frames[frame].sprite.destroy();
                        }	
                }
                
                function destroy_current_sprite_frames(){
                    destory_current_sprite_frames();	
                }
                function destory_all_clones(){
                    for(var sprite in sprites){
                        set_current_sprite_name(sprites[sprite].name);
                        /*
                        go=find_sprite_object_by_name(sprites[sprite].name)
                        if(go.clones.length==0) {//this is to make bomberman and nikutabero2 work at the same time
                            return;
                        }
                                    console.log("destroying: "+go.frames.length+" frames...");
            
                        */
                        //destory_current_sprite_frames();
                        for(var clone in sprites[sprite].clones){
                            sprites[sprite].clones[clone].sprite.destroy();
                            for(var frame in sprites[sprite].clones[clone].frames){
                                sprites[sprite].clones[clone].frames[frame].sprite.destroy();
                            }
                        }
                        sprites[sprite].clones=[];//remove this elements from the clones
                    }
                }
                function destroy_all_clones(){
                    destory_all_clones();
                }
                /*
                ...
                Blockly.Blocks['set_one_time_timer'] = {
                  init: function() {
                    this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                    this.appendStatementInput("statement")
                        .setCheck(null)
                        .appendField("set one time timer")
                        .appendField(new Blockly.FieldTextInput("timer name"), "timer_name")
                        .appendField("milliseconds")
                        .appendField(new Blockly.FieldTextInput("1000"), "milliseconds");
                    this.appendValueInput("ID_VAR")
                ...
                Blockly.JavaScript['set_one_time_timer'] = function(block) {
                  var text_timer_name = block.getFieldValue('timer_name');
                  var text_milliseconds = block.getFieldValue('milliseconds');
                  var statements_statement = Blockly.JavaScript.statementToCode(block, 'statement');
                  var value_id_var = Blockly.JavaScript.valueToCode(block, 'ID_VAR', Blockly.JavaScript.ORDER_ATOMIC);
                  ...
                  // TODO: Assemble JavaScript into code variable.
                    ...
                    code=code+ statements_statement+'\n';
                    code=code+'}\n';
                    code=code+'var ID = setTimeout(timersObj['+id+'], '+ms+');\n';
                    code=code+'timerIDs.push(ID);\n';
                    return code;
                };
           ...
           /*
            ...
            Blockly.JavaScript['http_request'] = function(block) {
              ...
              var value_post_data = Blockly.JavaScript.valueToCode(block, 'post_data', Blockly.JavaScript.ORDER_ATOMIC);
              var statements_response = Blockly.JavaScript.statementToCode(block, 'response');
              // TODO: Assemble JavaScript into code variable.
              var code ="";
                    code+="try {\n";
                        code+="if(window.location.hostname=='amigojapan.github.io'){alert('access restricted to HTTP request on this web page, please download the offline version to gain access to this feature');return;}\n";
                    code+= 'var http = new XMLHttpRequest();\n';
                      code+= 'var url = '+value_url+';\n';
                  code+= 'var params = '+value_post_data+'\n';
                if(value_post_data){
                      code+= 'http.open(\'POST\', url, true);\n';
                } else {
                      code+= 'http.open(\'GET\', url, true);\n';
                }
                  ...
                  code+= 'http.onreadystatechange = function() {//Call a function when the state changes.\n';
                        code+= '	if(http.readyState == 4 && http.status == 200) {\n';
                  code+=    	statements_response+'\n';
                        code+= '  }\n';
                  code+= '}\n';
                        code+= 'http.send(params);\n';
                        code+="} catch(err) {alert('ERROR'+err)}\n";
              return code;
            };
            Blockly.Blocks['api_http_response_text'] = {
              init: function() {
                this.appendDummyInput()
            ...
            Blockly.JavaScript['api_http_response_text'] = function(block) {
              // TODO: Assemble JavaScript into code variable.
            ...
            Blockly.Blocks['text_cls'] = {
              init: function() {
                this.appendDummyInput()
                    .appendField("clear terminal");
                this.setPreviousStatement(true, null);
                this.setNextStatement(true, null);
                this.setColour(120);
             this.setTooltip("");
            ...
            Blockly.JavaScript['text_cls'] = function(block) {
              // TODO: Assemble JavaScript into code variable.
              var code = 'cls();\n';
              return code;
            };
            Blockly.Blocks['api_fetch_json_value'] = {
              init: function() {
                this.appendDummyInput()
                    .appendField("fetch me a json value");
                this.appendValueInput("json_text")
                    .setCheck("String")
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField("json text");
                this.appendValueInput("full_path")
                    .setCheck("String")
                    .setAlign(Blockly.ALIGN_RIGHT)
                    .appendField("full path in form .node.node...");
                this.setOutput(true, null);
                this.setColour(230);
             this.setTooltip("");
             this.setHelpUrl("");
            ...
            Blockly.JavaScript['api_fetch_json_value'] = function(block) {
              var value_json_text = Blockly.JavaScript.valueToCode(block, 'json_text', Blockly.JavaScript.ORDER_ATOMIC);
              var value_full_path = Blockly.JavaScript.valueToCode(block, 'full_path', Blockly.JavaScript.ORDER_ATOMIC);
              // TODO: Assemble JavaScript into code variable.
              value_json_text = value_json_text.replace(/['$^']/g, "")
              value_full_path = value_full_path.replace(/['$^']/g, "");
              var   code = "String(eval(\'JSON.parse(\\\''+"+value_json_text+"+'\\\')"+ value_full_path +"\'))";//I know this is a security flaw, but it is a quick hack,someone else fix it please
              console.log(code);
              console.log(value_json_text);
              console.log(value_full_path);
              //eval('JSON.parse(\'{"t":{"u":"Aug 5, 2018 12:00:00 UTC"}}\').t.u')//desired
              //eval('JSON.parse(\''{"t":{"u":"Aug 5, 2018 12:00:00 UTC"}}'\')'.t.u'')//obtained
            ...
            //blockly end
            */
                function update_workspace_code_in_projet() {
                    var xml = Blockly.Xml.workspaceToDom(workspace);
                    var xml_text = Blockly.Xml.domToPrettyText(xml);
                    for(var pageindex in project.pages) {
                ...
                function call_init() {
                            ...
                            Blockly.JavaScript.addReservedWords('highlightBlock');
                            Blockly.JavaScript.STATEMENT_PREFIX = '';
                            document.getElementById("code_text_area").value = Blockly.JavaScript.workspaceToCode(workspace);
                            Blockly.JavaScript.STATEMENT_PREFIX = 'highlightBlock(%1);\n';
                            debuggerCode = Blockly.JavaScript.workspaceToCode(workspace);
                            */
                            debuggerCode = generateJS(false);
                            document.getElementById("code_text_area").value = debuggerCode;
                          //var xml = Blockly.Xml.workspaceToDom(workspace);
                            //var xml_text = Blockly.Xml.domToPrettyText(xml);
                          ...
                          //Unless I am mistaken there isn't a way currently to call into the context created when running a program with the JSInterpreter. On workaround could be to have a setInterval going inside the interpreter context that is polling an exposed api which is watching for events on the page and responds by calling your users code. https://neil.fraser.name/software/JS-Interpreter/docs.html
                            ...
                            //alert(finalCode);
                             var checkbox = document.getElementById("real-time-eval-checkbox");
                            if(!evalRun&&!URLRunLoading||checkbox.checked) {//this if statement prevents the code from running twice when the project loads if the code is already running because of RunAndLoadFromUrl paramenter on the URL
                                if(checkbox.checked) {
                                    destory_all_clones();
                                }
                                set_all_fames_to_first_frame();
                                var finalCode = generateJS(false);//**get the textare text here change form generateJS
                                finalCode+= "if (typeof ON_STARTUP !== 'undefined') {\n";//cehck to see if funtion is defined
               ...
               /*
                ...
                //blobk change stage https://blockly-demo.appspot.com/static/demos/blockfactory/index.html#tmykc7
                Blockly.Blocks['block_change_stage'] = {
                    init: function() {
                        this.appendValueInput("URL")
                                .setCheck("String")
                                .appendField("change stage. URL:");
                        this.setPreviousStatement(true, null);
                        this.setNextStatement(true, null);
                        this.setColour(65);
                        this.setTooltip('');
                ...
                Blockly.JavaScript['block_change_stage'] = function(block) {
                    var value_url = Blockly.JavaScript.valueToCode(block, 'URL', Blockly.JavaScript.ORDER_ATOMIC);
                    // TODO: Assemble JavaScript into code variable.
                    var code = 'if(evalRun) {window.location.href = '+ value_url +';}\n';
                    return code;
                };
                //End Blocks
            //imperitive:start interlacing blocks(this is not a commend)
                ...
                */
                ...
                function clikedDeleteLink(linkName) {
                 ...
                 for(var pageindex in project.pages){
                            ...
                            //make sure to do it by name, nor sure if the index will always be the same
                            for(var index in project.images) {
                                if(project.images[index].name==linkName) {
                                    //project.images.splice(13, 1);
                                    project.images.splice(index, 1);
                                    break;
                                }
                            ...
                            for(var index in sprites) {
                                if(sprites[index].name==linkName) {
                                    //sprites.splice(13, 1)
                                    sprites.splice(index, 1);
                                    break;
                                }
                            ...
                            for(var index in project.game_objects) {
                                if(project.game_objects[index].name==linkName) {
                                    //project.game_objects.splice(13, 1)
                                    project.game_objects.splice(index, 1);
                                    break;
                                }
                ...
                function if_frames_exist_set_frame_to_first_frame(go) {
                    for(var frame in go.frames) {
                        go.frames[frame].sprite.visible=false
                    } 
                    if(typeof go.frames != 'undefined'){//if there are any frames
                        go.frames[1].sprite.visible=true;
                ...
                onLoadedFrame_ForProject = function(){
                    ...
                    var local_game_object=find_sprite_object_by_name(current_sprite_name);
                    local_game_object.frames[local_game_object.number_of_frames]={};//need to have an object to hold the sprite
                    local_game_object.frames[local_game_object.number_of_frames].sprite = game.add.sprite(this.initial_x,this.initial_y,this.image_name);
                    /*
                    var x=local_game_object.sprite.x;
                    var y=local_game_object.sprite.y;
                    var key=project.game_objects[sprites.length-1].frames[local_game_object.number_of_frames-1].image_name;	
                    local_game_object.frames[local_game_object.number_of_frames].sprite = game.add.sprite(x,y,key);
                    */
                    ...
                    local_game_object.number_of_frames++//(2017_4_12)
                    /*(deteler 2017/4/4)
                ...
                onLoaded2 = function(){
                    ...
                    //set hidden to false(2017_4_12)
                    sprites[loader_current_sprite].hidden=false;
                    ...
                    game_object=find_sprite_object_by_name(current_sprite_name);
                    for(var index in project.game_objects) {
                        //for(var frame in project.game_objects[project.game_objects.length-1].frames) {
                        
                        if(project.game_objects[index].name==sprites[loader_current_sprite].name) {//seems these never macth for top_bear
                            for(var frame in project.game_objects[index].frames) {	
                                if(typeof project.game_objects[index].number_of_frames != 'undefined') {
                                    //dangerous(2017/4/4)
                                    if(typeof game_object.frames == 'undefined') {
                                        game_object.frames=[];
                                        game_object.number_of_frames=1;
                                        game_object.sprite.visible=true;
                                        game_object.current_frame=1;
                                        game_object.counter_of_loaded_image_frame=1;
                                    }
                                    //} else {
                                    //	game_object.number_of_frames++;I think this should be incremented in onLoadedFrame_ForProject (2017_4_12)
                                    //}
            
                                    
                                    loader = new Phaser.Loader(game)
                                    //loader.image(project.game_objects[index].frames[game_object.number_of_frames-1].image_name, project.game_objects[index].frames[game_object.number_of_frames-1].frame_image_data);
                                    var image_name=project.game_objects[index].frames[game_object.counter_of_loaded_image_frame-1].image_name;
                                    var frame_image_data=project.game_objects[index].frames[game_object.counter_of_loaded_image_frame-1].frame_image_data;
                                    game_object.counter_of_loaded_image_frame++;
                                    passed_object={};
                                    passed_object.initial_x=game.world.centerX//screen center
                                    passed_object.initial_y=game.world.centerY//screen center
                                    passed_object.image_name=image_name;
                                    loader.image(image_name, frame_image_data);
                                    loader.onLoadComplete.addOnce(onLoadedFrame_ForProject,passed_object);
                                    loader.start();
                                }
                            }
                        }
                ...
                document.getElementById("files").onchange = function () {
                    ...
                    reader.onload = function (e) {
                        ...
                        loader = new Phaser.Loader(game);//obsolete?
                        //try this
                        /*
                        ...
                        */
                        ...
                        /*
                        if(typeof project.game_objects[sprites.length-1].frames != 'undefined') {
                            sprites[sprites.length-1].number_of_frames=project.game_objects[sprites.length-1].number_of_frames;//sync frames from project to sprite(2017/4/4)
                        }
                        I suspect this is wrong because the sprites.length variable is not available when I try to make a second new sprite after deleting one, I will experiment with getting it fromt he project instead
                        */
                        //experiment follows:(2018/5/27) I modified it to th4e following, it fixed the current problem of the images not adding, but I suspect it may cause problems in images with many frames, text with bombermand...seems to work with the bombarman project I will backup the projects and replace this asa the most modern project
                        //not fixed, just noticed ti had to actually load the frames, setting it to 0 seemed to fix it, but it should be loading the frames if they exist
                        if(typeof project.game_objects[sprites.length-1] == 'undefined' ) {
                            sprites[sprites.length-1].number_of_frames='undefined';//hack to get it working(2018/7/4)
                        }else {
                            if(typeof project.game_objects[sprites.length-1].frames != 'undefined' ) {
                                sprites[sprites.length-1].number_of_frames=project.game_objects[sprites.length-1].number_of_frames;//sync frames from project to sprite(2017/4/4)
                            }
                ...
                function loadHelperFunctionformObj(project) {
                        ...
                        //**add loading js code
                        //RunCode=project.JScode
                        editor.setValue(project.JScode)
                        //Blockly.mainWorkspace.clear();
                ...
                function loadHelperFunction(project_json) {
                        console.log("Raw input to JSON.parse:", project_json);
                ...
                document.getElementById("files_project_upload").onchange = function () {
                    ...
                    reader.onload = function (e) {
                            ...
                            //loadHelperFunction(project_json);
                            loadHelperFunctionformObj(project_json)
                    };
                    // read the image file as a data URL.
                    reader.readAsText(this.files[0]);
                };
                function loaProjectFromJSONString(jsonapp) {
                    //console.log(jsonapp);
                    //project_json=JSON.parse(jsonapp);
                    //loadHelperFunctionformObj(project_json);
                    loadHelperFunction(jsonapp)
                    //if(RunCode) {
                    //    evalCode();
                    //}
                }
                function loadURLproject(URL,RunCode) {
                    ...
                    */
                    ...
                    xhr.overrideMimeType("application/json");  // <<< ensure JSON mode
                    xhr.onload = function (e) {
                        if (xhr.readyState === 4) {
                            if (xhr.status === 200) {
                                project_json=xhr.responseText;
                                loadHelperFunction(project_json);
                                if(RunCode) {
                                    evalCode();
                                    //ON_STARTUP();//trying to call the onstartup of the function so that it sets up the area before the game starts.
                                }
                            } else {
                    ...
                    if(RunCode) {
                        //hideIDE here if project needs to be running in publish mode
                        document.getElementById("arcade-banner").style.display="none";
                        document.getElementById("toolbar").style.display="none";
                        document.getElementById("arcade-border-left").style.display="none";
                        document.getElementById("arcade-border-right").style.display="none";
                        document.getElementById("controls menu").style.display="none";
                        //will need to add option to add screen controls
                    }
                    //*[@id="arcade-border-left"]
            ...
            */		
            ...
            amigojapan: Sadale: I will try making a small game as-is,    I think it would be better if we dont need to hide lots of functionality behind the scences...  maybe i can make a basic game loop where the user just inserts blocks where it is nessesary	
                    ...
                    [01:00am] LoLei がチャットルームを去りました。 (Ping timeout: 240 seconds)
                    ...
                    [01:04am] pooooooopsy がチャットルームに参加しました。
                    [01:04am] lktp がチャットルームに参加しました。
            ...
            [6:49pm] deltab: JSON doesn't have a way to represent that
                ...
                -(later)add all the array blocks from blockly playground for keeping track of the cells of bomberman(do I really need this? ah yes, to create the explotions and put the bombs in hte center of the array)
                -merge the parts of upload_load_project and url_open_project that are the same into some functions that can be shared
                -bomberman (use for each clone of bombs colide with bomberman, use foreach baddy collide with bomberman)
                    ...
                    -(later)testing how to use a 2D array in blocklyplayground
                    -make the game using integer round of hte x and y instead of arrays, this should be easier
                -mouse event suport
                -ABS block
                -print of GUI block
                -poop game
                ...
                -(sone,but I need to fix loadproject from URL to test it on smartphones)make screen controls(how can I make them repeat while they are pressed like keys do? (maybe a timer for each button huh...))
                ...
                -make a place to open examples directly by clicking on urls with screenshot thumbnails
                    
                priorities:everythiing before bomberman	
                ...
                fixed bug of screen controls nto working in app
                **    except that in pacman they dont work well
                */
              </script>
